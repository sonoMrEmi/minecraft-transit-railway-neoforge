...
public interface IPacket {
	...
	ResourceLocation PACKET_OPEN_FREE_NODE_SCREEN = MTR.id("packet_open_free_node_screen");
	...
	ResourceLocation PACKET_PROPAGATE_REPEATER_OFFSET = MTR.id("packet_propagate_repeater_offset");
	ResourceLocation PACKET_PROPAGATE_REPEATER_RESULT = MTR.id("packet_propagate_repeater_result");
